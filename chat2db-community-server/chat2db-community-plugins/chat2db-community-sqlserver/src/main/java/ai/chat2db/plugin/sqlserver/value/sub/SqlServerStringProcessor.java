...
public class SqlServerStringProcessor extends DefaultValueProcessor {
    ...
    public String convertJDBCValueStrByType(JDBCDataValue dataValue) {
        return SqlServerDmlValueTemplate.wrapString(EasyStringUtils.escapeString(dataValue.getStringValue()));
    }
}

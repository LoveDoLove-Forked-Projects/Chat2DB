...
public enum OracleViewSqlSecurityOptionEnum {
    ...
    public static FormConfig getFormConfig() {
        ...
        formConfig.setLabelName(I18nUtils.getMessage("gui.modify.view.config.definer"));
        formConfig.setName("definer");
        formConfig.setInputType(InputTypeEnum.SELECT.name().toLowerCase());
        OracleViewSqlSecurityOptionEnum[] values = OracleViewSqlSecurityOptionEnum.values();

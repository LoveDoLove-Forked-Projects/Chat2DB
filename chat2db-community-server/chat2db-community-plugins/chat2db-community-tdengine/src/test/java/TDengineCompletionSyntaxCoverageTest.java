...
public class TDengineCompletionSyntaxCoverageTest {

    @Test
    public void testMysqlFamilyNonCrudSyntaxThroughTDenginePlugin() {
        String sql = """
                START TRANSACTION READ ONLY;
                SAVEPOINT sp_tdengine;
                ROLLBACK TO SAVEPOINT sp_tdengine;
        ...
        assertParses(sql, DatabaseTypeEnum.TDENGINE);
    }

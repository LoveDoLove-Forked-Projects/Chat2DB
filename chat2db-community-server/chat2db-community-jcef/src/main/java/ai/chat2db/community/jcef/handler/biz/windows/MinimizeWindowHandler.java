...
@JcefAction(value = "minimize-window", method = "client-command")
public class MinimizeWindowHandler implements IJcefActionHandler {
    @Override
    public void handle(ConsoleMessage consoleMessage, ConsoleResult wsResult, CefQueryCallback callback) throws Exception {
        OSOperateUtil.windowsMin(JcefContext.getInstance().getFrame_());

export default {
  ...
  'knowledgeManagement.label.resourceScope': '적용 범위',
  'knowledgeManagement.label.globalScope': '전역',
  'knowledgeManagement.label.addScope': '범위 추가',
  'knowledgeManagement.tips.incompleteScope': '완전한 데이터 소스 범위를 선택하세요',

export default {
  ...
  'common.resultInspector.switchToModal': 'ダイアログで開く',
  'common.resultInspector.switchToSidebar': 'サイドバーで開く',
  ...
  'common.button.keepHistoryResult': '既存の結果を保持',
  ...
  'common.button.freezeColumn': '列を固定',
  'common.button.unfreezeAllColumns': 'すべての列の固定を解除',
  ...
  'common.selectBoundInfo.placeholder.dataSource': 'データソースを選択',
  'common.selectBoundInfo.placeholder.database': 'データベースを選択',
  'common.selectBoundInfo.placeholder.schema': 'スキーマを選択',
  'common.selectBoundInfo.scope.global': 'グローバル範囲',
  'common.selectBoundInfo.scope.dataSource': 'データソース全体',
  'common.selectBoundInfo.scope.database': 'データベース全体',

export default {
  ...
  'knowledgeManagement.terminology.description': 'Chat2DB がデータマイニングプロセスでターゲットの説明をよりよく理解できるように、ここでは、特定の用語を入力できます（データソースを指定することをサポートします。指定しない場合はグローバル効果）。',
  ...
  'knowledgeManagement.businessLogic.description': 'Chat2DB がデータベースに含まれるビジネスロジックをよりよく理解できるように、ここでは、詳細なロジックを入力できます（データソースを指定することをサポートします。指定しない場合はグローバル効果）。',
  ...
  'knowledgeManagement.annotationTable.description': 'Chat2DB は、データベーステーブルのフィールドに詳細な注釈を付けることをサポートします。これにより、AI はより正確にフィールドの意味を理解し、データ処理と分析の精度を向上させることができます。',
